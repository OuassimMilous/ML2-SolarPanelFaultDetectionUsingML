...
def logistic_regression(X_train, X_test, y_train, y_test):
    ...
    model = LogisticRegression(random_state=42, max_iter=500)  # Create a logistic regression model
...
def gradient_boosting(X_train, X_test, y_train, y_test):
    ...
    model = GradientBoostingClassifier(random_state=42)  # Create a Gradient Boosting model
    return evaluate_model(model, param_grid, X_train, X_test, y_train, y_test)
...
def random_forest(X_train, X_test, y_train, y_test):
    ...
    model = RandomForestClassifier(random_state=42)  # Create a Random Forest classifier model
    return evaluate_model(model, param_grid, X_train, X_test, y_train, y_test)
...
def svm(X_train, X_test, y_train, y_test):
    ...
    model = SVC(random_state=42)  # Create an SVM model
    return evaluate_model(model, param_grid, X_train, X_test, y_train, y_test)
